    ...
    <div className="animate-slide-up fixed inset-x-0 bottom-0 z-[90] border-t border-rule bg-paper/95 backdrop-blur-md">
      <div className="mx-auto flex max-w-6xl flex-col gap-3 px-4 py-3 sm:flex-row sm:items-center sm:justify-between sm:px-6">
        ...
        <div className="flex shrink-0 gap-2">
          <Link
            href="/docs"
            className="rounded-lg border border-rule px-3 py-2 text-[11px] uppercase tracking-[0.12em] text-mute transition-colors duration-150 hover:border-ink hover:text-ink"
          >
            Docs
          </Link>
          <button
